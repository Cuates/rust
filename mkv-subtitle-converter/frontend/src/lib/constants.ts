...
export const CMD_GET_DIRECTORY_STATS = 'get_directory_stats';
export const CMD_READ_REPORT_FILE = 'read_report_file';
export const CMD_GET_HISTORY_COUNT = 'get_history_count';
