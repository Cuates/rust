...
## Process
1. Read `START_HERE.md`, `plan.md`, `docs/KNOWLEDGE_GRAPH.md`, `.agents/AGENTS.md`, and the `docs/adr/` directory. Also review `docs/architecture.md`, `frontend/README.md`, and `backend/README.md`.
