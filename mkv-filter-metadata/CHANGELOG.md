...
- Displayed the total size of processed files directly within the real-time output pipeline log.
- Separated final pipeline summary metrics onto individual lines in the terminal log for better readability.
