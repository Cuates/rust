...
| `types.ts`           | Zod schemas and TypeScript interfaces auto-generated by the Rust backend (`export_zod.rs`) for 100% IPC payload matching.                                |
...
- **Strict Payload Typing:** All IPC requests and backend events are fully typed via auto-generated Specta/Zod definitions, eliminating silent communication failures.
