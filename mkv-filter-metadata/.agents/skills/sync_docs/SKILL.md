...
2. **Checks Performed**:
   ...
   - Ensure new ADRs (like `0007-adaptive-throttling-and-storage-concurrency.md`, `0012-github-actions-release-pipeline.md`, and `0013-strict-ipc-type-generation.md`) are properly indexed in `docs/architecture.md`.
3. **Actions**: 
